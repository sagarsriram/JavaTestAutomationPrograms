...
public class POM4assignment {
	...
	static void modifyCustomer()
	{
		try
		{
			...
			getpage.getcusomtermodifydescrptionarea().sendKeys("customer-details");Thread.sleep(2000);
			getpage.getcustomersettingclosebutton().click();
		}catch(Exception e)
		{
			e.printStackTrace();
		}
